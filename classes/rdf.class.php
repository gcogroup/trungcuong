<?php
/* $Id: rdf.class.php,v 1.3 2003/11/15 18:54:05 saka_car Exp $ */
...
* @version   1.6 ($Date: 2003/11/15 18:54:05 $) $Revision: 1.3 $
* @access    public
*/
...
class fase4_rdf {
	...
	*/
	...
	global $mosConfig_offset;
		...
		$this->_refresh = (time() + $mosConfig_offset*60*60 - 1200);
	}
    ...
    *
    * @access    private
    * @param     array $array Itemarray
	* @author    Stefan Saasen <s@fase4.com>
    * @see       _item
    */
    function _clear_Items( $array = "") {
            $this->_item = array ("title"=>"", "link"=>"", "description"=>"", "url"=>"","lastBuildDate" => "", "width" => "", "height" => "");
    }
    /**
    * This Method clears the Array containig the Channel Items.
    *
    * @access    private
    * @param     array $array Array containing the Channel Items
	* @author    Stefan Saasen <s@fase4.com>
    * @see       _item
    */
    function _clear_cItems( $array = "") {
            $this->_citem = array ("title"=>"", "link"=>"", "description"=>"", "url"=>"","lastBuildDate" => "", "width" => "", "height" => "" );
    }
    ...
    */
    function _get_ChannelData( $parser )
	{
                ...
                $this->_output .= "<tr><td class=\"fase4rdf\">".strip_tags($this->_citem["description"], "<a>, <img>")."</td></tr>\n";
                $this->_output .= "<tr><td class=\"fase4rdf\"><div class=\"fase4_rdf_title\">".htmlspecialchars($this->_citem["title"])."</div></td></tr>\n";
                $this->_output .= "<tr><td>&nbsp;</td></tr>\n";
                $this->_output .= "<tr><td class=\"fase4rdf\">\n";
                if($this->_display_opt["build"] != "hidden") {
                    if(isset($this->_citem["lastBuildDate"])){$this->_output .= "build: ". $this->_citem["lastBuildDate"]."<br />";}
                }
                ...
                $this->_output .= "</table></td></tr>";
                    ...
                    $this->_array_channel = array(  "title"=>$this->_citem["title"],
                                                    ...
                                                    "lastBuildDate"=>(isset($this->_citem["lastBuildDate"]) ? $this->_citem["lastBuildDate"] : ""));
    }
        ...
        switch ($name) {
            case "item":
                if(empty($this->_max_count) OR $this->_item_count < $this->_max_count) {
                    if($this->_item["title"] != $this->_item["description"]
        				...
        				$this->_output .= "<tr><td class=\"fase4rdf\">".strip_tags($this->_item["description"], "<a>, <img>")."</td></tr>\n";
                        $this->_output .= "<tr><td class=\"fase4rdf\"><a href=\"".$this->_item["link"]."\" ";
                        if(isset($this->_link_target)) { $this->_output .= "target=\"".$this->_link_target."\" "; }
            ...
            case "channel":
                if($this->_display_opt["channel"] != "hidden" AND $this->_item["title"] != "") {
                    $this->_output .= "<tr><td>\n";
                    $this->_output .= '<table border="0" width="100%" class="fase4_rdf_meta" cellspacing="5" cellpadding="2">'."\n";
                    $this->_output .= "<tr><td class=\"fase4rdf\"><div class=\"fase4_rdf_title\">".htmlspecialchars($this->_item["title"])."</div></td></tr>\n";
                    $this->_output .= "<tr><td class=\"fase4rdf\">".strip_tags($this->_item["description"], "<a>, <img>")."</td></tr>\n";
                    $this->_output .= "<tr><td>&nbsp;</td></tr>\n";
                    $this->_output .= "<tr><td class=\"fase4rdf\">\n";
                if($this->_display_opt["build"] != "hidden") {
    ...
    function _parseData($parser, $text)
    {
        ...
        if ($clean)
        {
            ...
            if($this->_parse_mode == "all")
            {
				...
				if(!isset($this->_tags[$this->_depth[$parser]]))
					$this->_tags[$this->_depth[$parser]] = "";
            ...
            elseif ($this->_parse_mode == "channel")
            {
				...
				if(!isset($this->_ctags[$this->_cdepth[$parser]]))
					$this->_ctags[$this->_cdepth[$parser]] = "";
