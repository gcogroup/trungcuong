<?
$DevEditPath2=$CONFIG['dir_path']."/1234568/de";?>
<table width="100%" cellspacing="0" cellpadding="0" class=toolbar>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="hide" align="center" id="toolbar_preview">
		<tr>
		  <td class="body" height="24">
		  &nbsp;<img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/popups/preview.gif" width="21" height="20" align=absmiddle>&nbsp;Preview Mode
		  </td>
		 </tr>
	</table>
		  ...
		  <table border="0" cellspacing="0" cellpadding="1">
			  <tr id=de>
				<?php if($this->__hideSave != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_save.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='saveDevEdit();' title="<?php echo sTxtSave; ?>" class=toolbutton></td>
				<?php } ?>
				<?php if($this->__hideFullScreen != true) { ?>
					<td>
						<img id=fullscreen2 border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_fullscreen.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='toggleSize();foo.focus();' title="<?php echo sTxtFullscreen; ?>" class=toolbutton></td>
				<?php } ?>
				<td>
				  <img border="0" disabled id="toolbarCut2_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_cut_disabled.gif" width="21" height="20" title="<?php echo sTxtCut; ?> (Ctrl+X)" class=toolbutton><img border="0" id="toolbarCut2_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_cut.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Cut");foo.focus();' title="<?php echo sTxtCut; ?> (Ctrl+X)" class=toolbutton style="display:none"></td>
				<td>
				  <img border="0" disabled id="toolbarCopy2_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_copy_disabled.gif" width="21" height="20" title="<?php echo sTxtCopy; ?> (Ctrl+C)" class=toolbutton><img border="0" id="toolbarCopy2_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_copy.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Copy");foo.focus();' title="<?php echo sTxtCopy; ?> (Ctrl+C)" class=toolbutton style="display:none"></td>
				<td>
				  <img border="0" disabled id="toolbarPasteButton2_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_paste_disabled.gif" width="21" height="20" title="<?php echo sTxtPaste; ?> (Ctrl+V)" class=toolbutton><img border="0" id="toolbarPasteButton2_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_paste.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Paste");foo.focus();' title="<?php echo sTxtPaste; ?> (Ctrl+V)" class=toolbutton style="display:none"></td>
				<td>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_find.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='ShowFindDialog();foo.focus();' title="<?php echo sTxtFindReplace; ?>" class=toolbutton></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				<td>
				  <img border="0" disabled id="undo2_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_undo_disabled.gif" width="21" height="20" title="<?php echo sTxtUndo; ?> (Ctrl+Z)" class=toolbutton><img border="0" id="undo2_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_undo.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Undo");' title="<?php echo sTxtUndo; ?> (Ctrl+Z)" class=toolbutton style="display:none"></td>
				<td>
				  <img border="0" disabled id="redo2_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_redo_disabled.gif" width="21" height="20" title="<?php echo sTxtRedo; ?> (Ctrl+Y)" class=toolbutton><img border="0" id="redo2_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_redo.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Redo");' title="<?php echo sTxtRedo; ?> (Ctrl+Y)" class=toolbutton style="display:none"></td>
				</tr>
			</table>
		  </td>
		 </tr>
		<tr>
		  <td class="body" bgcolor="#808080"><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/1x1.gif" width="1" height="1"></td>
		</tr>
		<tr>
		  <td class="body" bgcolor="#FFFFFF"><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/1x1.gif" width="1" height="1"></td>
		</tr>
		  ...
		  <td class="body" height="22">
			<table border="0" cellspacing="0" cellpadding="1" id=toolbar1>
			  <tr id=de>
				  <?php if($this->__hideSave != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_save.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='saveDevEdit();' title="Save" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideFullScreen != true) { ?>
					<td>
						<img id=fullscreen border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_fullscreen.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='toggleSize();foo.focus();' title="<?php echo sTxtFullscreen; ?>" class=toolbutton></td>
				  <?php } ?>
					<td>
						<img border="0" disabled id="toolbarCut_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_cut_disabled.gif" width="21" height="20" title="<?php echo sTxtCut; ?> (Ctrl+X)" class=toolbutton><img border="0" id="toolbarCut_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_cut.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Cut");foo.focus();' title="<?php echo sTxtCut; ?> (Ctrl+X)" class=toolbutton style="display:none"></td>
					<td>
						<img border="0" disabled id="toolbarCopy_off" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_copy_disabled.gif" width="21" height="20" title="<?php echo sTxtCopy; ?> (Ctrl+C)" class=toolbutton><img border="0" id="toolbarCopy_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_copy.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Copy");foo.focus();' title="<?php echo sTxtCopy; ?> (Ctrl+C)" class=toolbutton style="display:none"></td>
					<td>
						<img id=toolbarPasteButton_off disabled class=toolbutton width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_paste_disabled.gif" border=0 unselectable="on" title="<?php echo sTxtPaste; ?> (Ctrl+V)"><img id=toolbarPasteButton_on class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this); button_over(toolbarPasteDrop_on)" onClick="doCommand('Paste'); foo.focus()" onMouseOut="button_out(this); button_out(toolbarPasteDrop_on);" width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_paste.gif" border=0 unselectable="on" title="<?php echo sTxtPaste; ?> (Ctrl+V)" style="display:none"><img id=toolbarPasteDrop_off disabled class=toolbutton width="7" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_drop_menu_disabled.gif" border=0 unselectable="on"><img id=toolbarPasteDrop_on class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this); button_over(toolbarPasteButton_on)" onClick="showMenu('pasteMenu',180,42)" onMouseOut="button_out(this); button_out(toolbarPasteButton_on);" width="7" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_drop_menu.gif" border=0 unselectable="on" style="display:none"></td>
					<td>
					  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_find.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='ShowFindDialog();foo.focus();' title="<?php echo sTxtFindReplace; ?>" class=toolbutton></td>
					<td>
						<img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
					<td>
						<img id="undo_off" disabled UNSELECTABLE="on" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_undo_disabled.gif" width="21" height="20" title="<?php echo sTxtUndo; ?> (Ctrl+Z)" class=toolbutton><img id="undo_on" UNSELECTABLE="on" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_undo.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='goHistory(-1);' title="<?php echo sTxtUndo; ?> (Ctrl+Z)" class=toolbutton style="display:none"></td>
					<td>
						<img id="redo_off" disabled UNSELECTABLE="on" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_redo_disabled.gif" width="21" height="20" title="<?php echo sTxtRedo; ?> (Ctrl+Y)" class=toolbutton><img id="redo_on" UNSELECTABLE="on" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_redo.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='goHistory(1);' title="<?php echo sTxtRedo; ?> (Ctrl+Y)" class=toolbutton style="display:none"></td>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>

				  <?php if($this->__hideSpelling != true) { ?>
					<td>
						<img id="toolbarSpell" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_spellcheck.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='spellCheck();' title="<?php echo sTxtCheckSpelling; ?> (F7)" class=toolbutton></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				  <?php } ?>

				  <?php if($this->__hideRemoveTextFormatting != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_remove_format.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("RemoveFormat");' title="<?php echo sTxtRemoveFormatting; ?>" class=toolbutton></td>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				  <?php } ?>
				  <?php if($this->__hideBold != true) { ?>
					<td>
						<img id="fontBold" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_bold.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Bold");foo.focus();' title="<?php echo sTxtBold; ?> (Ctrl+B)" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideUnderline != true) { ?>
					<td>
						<img id="fontUnderline" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_underline.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Underline");foo.focus();' title="<?php echo sTxtUnderline; ?> (Ctrl+U)" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideItalic != true) { ?>
					<td>
						<img id="fontItalic" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_italic.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Italic");foo.focus();' title="<?php echo sTxtItalic; ?> (Ctrl+I)" class=toolbutton></td>
				  <?php } ?>

				<?php if($this->__hideStrikethrough != true) { ?>
					<td>
						<img id="fontStrikethrough" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_strikethrough.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Strikethrough");foo.focus();' title="<?php echo sTxtStrikethrough; ?>" class=toolbutton></td>
				<?php } ?>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>

				  <?php if($this->__hideNumberList != true) { ?>
					<td>
						<img id="fontInsertOrderedList" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_numbers.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("InsertOrderedList");foo.focus();' title="<?php echo sTxtNumList; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideBulletList != true) { ?>
					<td>
						<img id="fontInsertUnorderedList" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_bullets.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("InsertUnorderedList");foo.focus();' title="<?php echo sTxtBulletList; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideDecreaseIndent != true) { ?>
					<td>
					<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_decrease_indent.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Outdent");foo.focus();' title="<?php echo sTxtDecreaseIndent; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideIncreaseIndent != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_increase_indent.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Indent");foo.focus();' title="<?php echo sTxtIncreaseIndent; ?>" class=toolbutton></td>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				  <?php } ?>
				  <?php if($this->__hideSuperScript != true) { ?>
					<td>
						<img id="fontSuperScript" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_superscript.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("superscript");foo.focus();' title="<?php echo sTxtSuperscript; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideSubScript != true) { ?>
					<td>
						<img id="fontSubScript" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_subscript.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("subscript");foo.focus();' title="<?php echo sTxtSubscript; ?>" class=toolbutton></td>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				  <?php } ?>
				  <?php if($this->__hideLeftAlign != true) { ?>
					<td>
						<img id="fontJustifyLeft" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_align_left.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyLeft");foo.focus();' title="<?php echo sTxtAlignLeft; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideCenterAlign != true) { ?>
					<td>
						<img id="fontJustifyCenter" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_align_center.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyCenter");foo.focus();' title="<?php echo sTxtAlignCenter; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideRightAlign != true) { ?>
					<td>
						<img id="fontJustifyRight" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_align_right.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyRight");foo.focus();' title="<?php echo sTxtAlignRight; ?>" class=toolbutton></td>
				  <?php } ?>
				  <?php if($this->__hideJustify != true) { ?>
					<td>
						<img id="fontJustifyFull" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_align_justify.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyFull");foo.focus();' title="<?php echo sTxtAlignJustify; ?>" class=toolbutton></td>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				  <?php } ?>
				  <?php if($this->__hideLink != true) { ?>
					<td>
						<img disabled id="toolbarLink_off" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_link_disabled.gif" width="21" height="20" title="<?php echo sTxtHyperLink; ?>" class=toolbutton><img id="toolbarLink_on" border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_link.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doLink()' title="<?php echo sTxtHyperLink; ?>" class=toolbutton style="display:none"></td>
				  <?php } ?>
				  <?php if($this->__hideMailLink != true) { ?>
					<td>
						<img border="0" id="toolbarEmail_off" disabled src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_email_disabled.gif" width="21" height="20" title="<?php echo sTxtEmail; ?>" class=toolbutton><img border="0" id="toolbarEmail_on" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_email.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doEmail()' title="<?php echo sTxtEmail; ?>" class=toolbutton style="display:none"></td>
				  <?php } ?>
				  <?php if($this->__hideAnchor != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_anchor.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doAnchor()' title="<?php echo sTxtAnchor; ?>" class=toolbutton></td>
					<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				  <?php } ?>
				  <?php if($this->__hideHelp != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_help.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doHelp()' title="<?php echo sTxtHelp; ?>" class=toolbutton></td>
				  <?php } ?>
			  </tr>
			</table>
		  </td>
		  ...
		  <table border="0" cellspacing="0" cellpadding="1" id="toolbar2">
			  <tr id=de>
				...
				<?php if($this->__hideForeColor != true) {
					...
					if(is_numeric(strpos($_SERVER["$HTTPStr_USER_AGENT"], "Windows NT 5.1")))
						$xp = "_xp";
					elseif(is_numeric(strpos($_SERVER["$HTTPStr_USER_AGENT"], "Windows 98")))
						$xp = "_98";

				?>

				<td><span id=fontColor><img id=toolbarFont border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_font_color<?php echo $xp; ?>.gif" width="21" height="20" onmouseover="button_over(this);  button_over(toolbarFontdrop)" onmouseout="button_out(this); button_out(toolbarFontdrop)" onmousedown="button_down(this);" onClick="(isAllowed()) ? doColorDirectly(1) : foo.focus()" class=toolbutton title="<?php echo sTxtColour; ?>"></span><img id=toolbarFontdrop class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this); button_over(toolbarFont)" onClick="(isAllowed()) ? showMenu('colorMenu',157,158) : foo.focus()" onMouseOut="button_out(this); button_out(toolbarFont);" width="7" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_drop_menu.gif" border=0 unselectable="on"></td>
				<?php } ?>
				<?php if($this->__hideBackColor != true) { ?>
				<td><span id=fontHighlight><img id=toolbarHighlight border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_highlight<?php echo $xp; ?>.gif" width="21" height="20" onmouseover="button_over(this);  button_over(toolbarHighlightdrop)" onmouseout="button_out(this); button_out(toolbarHighlightdrop)" onmousedown="button_down(this);" onClick="(isAllowed()) ? doColorDirectly(2) : foo.focus()" class=toolbutton title="<?php echo sTxtBackColour; ?>"></span><img id=toolbarHighlightdrop class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this); button_over(toolbarHighlight)" onClick="(isAllowed()) ? showMenu('colorMenu2',157,158) : foo.focus()" onMouseOut="button_out(this); button_out(toolbarHighlight);" width="7" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_drop_menu.gif" border=0 unselectable="on"></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				<?php } ?>
				<?php if($this->__hideTable != true) { ?>
				<td id=toolbarTables>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_table_down.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="(isAllowed()) ? showMenu('tableMenu',160,262) : foo.focus()" class=toolbutton title="<?php echo sTxtTableFunctions; ?>"></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				<?php } ?>
				<?php if($this->__hideForm != true) { ?>
				<td>
				  <img class=toolbutton onMouseDown=button_down(this); onMouseOver=button_over(this); onClick="(isAllowed()) ? showMenu('formMenu',180,210) : foo.focus()" onMouseOut=button_out(this); type=image width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_form_down.gif" border=0 title="<?php echo sTxtFormFunctions; ?>"></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				<?php } ?>
				
				<?php if($this->__hideFlash != true) { ?>
				<td>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_flash.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="doFlash()" class=toolbutton title="<?php echo sTxtFlash; ?>"></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				<?php } ?>

				<?php if($this->__hideImage != true) { ?>
				<td>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_image.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="doImage()" class=toolbutton title="<?php echo sTxtImage; ?>"></td>
				<td><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/seperator.gif" width="2" height="21"></td>
				<?php } ?>
				<?php if($this->__hideTextBox != true) { ?>
				<td>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_textbox.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="doTextbox()" class=toolbutton title="<?php echo sTxtTextbox; ?>"></td>
				<?php } ?>
				 <?php if($this->__hideHorizontalRule != true) { ?>
					<td>
						<img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_hr.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("InsertHorizontalRule");foo.focus();' title="<?php echo sTxtInsertHR; ?>" class=toolbutton></td>
				  <?php } ?>
				<?php if($this->__hideSymbols != true) { ?>
				<td>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_chars.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="doChars()" class=toolbutton title="<?php echo sTxtChars; ?>"></td>
				<?php } ?>
				<?php if($this->__hideProps != true) { ?>
				<td>
				  <img border="0" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_properties.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="ModifyProperties()" class=toolbutton title="<?php echo sTxtPageProperties; ?>"></td>
				<?php } ?>

				<?php if($this->__hideClean != true) { ?>
				<td>				
				  <img class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" onClick="cleanCode()" onmouseout="button_out(this);" type=image width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_clean_code.gif" border=0 title="<?php echo sTxtCleanCode; ?>"></td>
				<?php } ?>

				<?php if($this->__hasCustomInserts == true) { ?>
				<td>
					<img class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" onClick="doCustomInserts()" onmouseout="button_out(this);" type=image width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_custom_inserts.gif" border=0 title="<?php echo sTxtCustomInserts; ?>"></td>
				<?php } ?>

				<?php if($this->__hideAbsolute != true) { ?>
				<td>
					<img id="fontAbsolutePosition_off" disabled class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_absolute_disabled.gif" border=0 title="<?php echo sTxtTogglePosition; ?>"><img id="fontAbsolutePosition" class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" onClick="doCommand('AbsolutePosition')" onmouseout="button_out2(this);" type=image width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_absolute.gif" border=0 title="<?php echo sTxtTogglePosition; ?>" style="display:none"></td>
				<?php } ?>

				<?php if($this->__hideGuidelines != true) { ?>
				<td>
				  <img class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this);" onClick="toggleBorders()" onMouseOut="button_out2(this);" type=image width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_show_borders.gif" border=0 title="<?php echo sTxtToggleGuidelines; ?>" id=guidelines></td>
				<?php } ?>
...
<table border="0" cellspacing="0" cellpadding="0" width=160 style="BORDER-LEFT: buttonhighlight 1px solid; BORDER-RIGHT: buttonshadow 2px solid; BORDER-TOP: buttonhighlight 1px solid; BORDER-BOTTOM: buttonshadow 1px solid;" bgcolor="threedface">
  ...
  <tr height=10> 
	<td align=center><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/vertical_spacer.gif" width="140" height="2"></td>
  </tr>
  ...
  <tr height=10> 
	<td align=center><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/vertical_spacer.gif" width="140" height="2" tabindex=1 HIDEFOCUS></td>
  </tr>
...
<table border="0" cellspacing="0" cellpadding="0" width=180 style="BORDER-LEFT: buttonhighlight 1px solid; BORDER-RIGHT: buttonshadow 2px solid; BORDER-TOP: buttonhighlight 1px solid; BORDER-BOTTOM: buttonshadow 1px solid;" bgcolor="threedface">
  <tr title="<?php echo sTxtForm; ?>" onClick=parent.insertForm() onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_form.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtForm; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtFormModify; ?>" onClick=parent.modifyForm() onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" id="modifyForm1" height=22 class=dropDown>
	  <img id="modifyForm2" width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_modify_form.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtFormModify; ?>...&nbsp;</td>
  </tr>
  <tr height=10> 
	<td align=center><img src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/vertical_spacer.gif" width="140" height="2" tabindex=1 HIDEFOCUS></td>
  </tr>
  <tr title="<?php echo sTxtTextField; ?>" onClick=parent.doTextField() onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_textfield.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtTextField; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtTextArea; ?>" onClick=parent.doTextArea() onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img type=image width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_textarea.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtTextArea; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtHidden; ?>" onClick=parent.doHidden(); onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_hidden.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtHidden; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtButton; ?>" onClick=parent.doButton(); onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_button.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtButton; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtCheckbox; ?>" onClick=parent.doCheckbox(); onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_checkbox.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtCheckbox; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtRadioButton; ?>" onClick=parent.doRadio(); onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_radio.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtRadioButton; ?>...&nbsp;</td>
  </tr>
  <tr title="<?php echo sTxtSelect; ?>" onClick=parent.doSelect(); onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
	<td style="cursor: hand; font:8pt tahoma;" height=22>
	  <img width="21" height="20" src="<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$DevEditPath2; ?>/de_images/button_select.gif" border=0 align="absmiddle">&nbsp;<?php echo sTxtSelect; ?>...&nbsp;</td>
  </tr>
</table>
</div>
<!-- formMenu -->
