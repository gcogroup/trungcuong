...
function switchFlashLibrary(thePath)
{
	...
	document.location.href = '<?php echo $HTTPStr . "://" . $_SERVER['HTTP_HOST']."/1234568/de/class.devedit.php"; ?>?ToDo=InsertFlash&DEP=<?php echo @$_GET["DEP"]; ?>&DEP1=<?php echo @$_GET["DEP1"]; ?>&flashDir='+thePath+'&dd=<?php echo $_GET["dd"]; ?>&du=<?php echo $_GET["du"]; ?>&wi=<?php echo $_GET["wi"]; ?>&tn=<?php echo $_GET["tn"]; ?>&dt=<?php echo $_GET["dt"]; ?>&wi=<?php echo $HideWebFlash; ?>';
}
...
function deleteFlash(flashSrc)
{
	...
	if (delImg == true) {
		document.location.href = '<?php echo $HTTPStr . "://" . $_SERVER['HTTP_HOST']."/1234568/de/class.devedit.php"; ?>?ToDo=DeleteFlash&DEP=<?php echo @$_GET["DEP"]; ?>&DEP1=<?php echo @$_GET["DEP1"]; ?>&flashDir=<?php echo $FlashDirectory; ?>&tn=<?php echo $_GET["tn"]; ?>&dt=<?php echo $_GET["dt"]; ?>&wi=<?php echo $HideWebFlash; ?>&du=<?php echo $_GET["du"]; ?>&dd=<?php echo $dd; ?>&flashSrc='+flashSrc;
	}
...
var flashFolder = "<?php echo $HTTPStr.'://'.$_SERVER['HTTP_HOST'].$FlashDirectory; ?>/"
var previousFlash
...
function CheckFlashForm()
{
	...
	var flashDir = '<?php echo "$HTTPStr://".$_SERVER['HTTP_HOST'].$FlashDirectory; ?>';
...
<form enctype="multipart/form-data" action="<?php echo $HTTPStr . "://" . $_SERVER['HTTP_HOST']."/1234568/de/class.devedit.php"; ?>?ToDo=UploadFlash&DEP=<?php echo @$_GET["DEP"]; ?>&DEP1=<?php echo @$_GET["DEP1"]; ?>&flashDir=<?php echo $FlashDirectory; ?>&wi=<?php echo $HideWebFlash; ?>&tn=<?php echo $tn; ?>&dd=<?php echo $dd; ?>&dt=<?php echo $dt; ?>&du=<?php echo $du; ?>" method="post" onSubmit="return CheckFlashForm()">
